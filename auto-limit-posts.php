...
function alpr_replace_content($content)
{
	...
	if ($alpr_post_wordcut == "Wordcut")
	{
		...
		if ( (is_home() && $alpr_post_home == "on") || (is_category() && $alpr_post_category == "on") || (is_archive() && $alpr_post_archive == "on") || (is_search() && $alpr_post_search == "on") ) {
			...
			$new_string2 = substr($content2, 0,$alpr_post_letters+3);
			$end_string2 = substr($new_string2, -5);
			$endingp = "";
			
			// Limit the post by letter
			$new_string = substr($content, 0,$alpr_post_letters+3);
...
<label style="margin-left:14px;"><input type="checkbox" name="alpr_striptags" <?php if($alpr_striptags == "on"){ echo 'checked="checked"'; } ?>/> <b>Strip tags and shortcodes</b> : : disable images, videos, links in the excerpt</label>
	...
	<ul style="margin-left:25px;">
		<li>This displays simple text, preventing code errors when posts are cut; activate when you limit by letter / word.</li>
	</ul>
...
<div align="center" style="padding:22px;font-size:17px;letter-spacing:1px;">
	...
	Check&nbsp; <a style="color:#2b95ff;text-decoration:none;font-size:18px;" target="_blank" href="http://www.thefreewindows.com/5598/socializer-share-wordpress-posts-pages/">Socializer! for WordPress</a> &nbsp;&&nbsp; <a style="color:#2b95ff;text-decoration:none;font-size:18px;" target="_blank" href="http://www.thefreewindows.com/15816/reveal-posts-visitors-share-social-networks/">Social Share Motivator</a></div>
...
function autolimitposts_settings_link($links) { 
  $settings_link = '<a href="options-general.php?page=auto-limit-posts/auto-limit-posts.php">Settings</a>'; 
...
function alpr_addpage() {
    add_submenu_page('options-general.php', 'Auto Limit Posts', 'Auto Limit Posts', 10, __FILE__, 'alpr_admin');
}
